...
export const connectToLiveSafety = (callbacks: {
  ...
  return ai.live.connect({
    ...
    config: {
      ...
      systemInstruction: 'أنت الآن في مكالمة صوتية مباشرة بصفتك "سلامتك" من وحدة HSE. كن سريع الاستجابة، واضحاً، ومختصراً لأن المستخدم يستمع إليك ولا يقرأ. ابدأ المكالمة بترحيب حار: "معك سلامتك، كيف أساعدك في أمور السلامة الآن؟"',
